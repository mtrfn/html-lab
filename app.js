...
headings:`<!DOCTYPE html><html lang="ro"><body>
<h1>Titlul principal</h1>
<h2>Un subtitlu</h2>
<p>Acesta este un paragraf.</p>
</body></html>`,
lists:`<!DOCTYPE html><html lang="ro"><body>
<h1>Componentele unui calculator</h1>
<ul><li>Procesor</li><li>Memorie RAM</li><li>SSD</li></ul>
</body></html>`,
table:`<!DOCTYPE html><html lang="ro"><body>
<h1>Orar</h1>
...
document.getElementById("run").onclick=run;document.getElementById("save").onclick=local;document.getElementById("download").onclick=download;
document.getElementById("open").onclick=()=>F.click();
...
X.onchange=()=>{E.value=examples[X.value];run()};
document.getElementById("reset").onclick=()=>{if(confirm("Revii la exemplul selectat?")){E.value=examples[X.value];run()}};
